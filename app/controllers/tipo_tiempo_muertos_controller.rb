class TipoTiempoMuertosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tipo_tiempo_muerto.save
        format.html { redirect_to @tipo_tiempo_muerto, notice: t("flash.created", model: "Tipo tiempo muerto") }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to tipo_tiempo_muertos_path, status: :see_other, notice: t("flash.destroyed", model: "Tipo tiempo muerto") }
