class SectorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @sector.save
        format.html { redirect_to @sector, notice: t("flash.created", model: "Sector") }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to sectors_path, status: :see_other, notice: t("flash.destroyed", model: "Sector") }
