class RetrabajosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @retrabajo.save
        format.html { redirect_to @retrabajo, notice: t("flash.created", model: "Retrabajo") }
  ...
  def update
    respond_to do |format|
      if @retrabajo.update(retrabajo_params)
        format.html { redirect_to @retrabajo, notice: t("flash.updated", model: "Retrabajo") }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to retrabajos_path, status: :see_other, notice: t("flash.destroyed", model: "Retrabajo") }
