class TipoObrasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tipo_obra.save
        format.html { redirect_to @tipo_obra, notice: "Tipo obra creado correctamente." }
  ...
  def update
    respond_to do |format|
      if @tipo_obra.update(tipo_obra_params)
        format.html { redirect_to @tipo_obra, notice: "Tipo obra actualizado correctamente." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to tipo_obras_path, status: :see_other, notice: "Tipo obra eliminado correctamente." }
