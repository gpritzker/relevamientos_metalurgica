class ParteProduccionsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @parte_produccion.update(parte_produccion_params)
        format.html { redirect_to @parte_produccion, notice: t("flash.updated", model: "Parte produccion") }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to parte_produccions_path, status: :see_other, notice: t("flash.destroyed", model: "Parte produccion") }
