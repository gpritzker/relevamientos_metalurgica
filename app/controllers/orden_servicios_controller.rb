class OrdenServiciosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @orden_servicio.save
        format.html { redirect_to @orden_servicio, notice: t("flash.created", model: "Orden servicio") }
  ...
  def update
    respond_to do |format|
      if @orden_servicio.update(orden_servicio_params)
        format.html { redirect_to @orden_servicio, notice: t("flash.updated", model: "Orden servicio") }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to orden_servicios_path, status: :see_other, notice: t("flash.destroyed", model: "Orden servicio") }
